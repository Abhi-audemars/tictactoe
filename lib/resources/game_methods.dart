  ...
  void checkWinner(BuildContext context, Socket socketClient) {
    ...
    if (winner != '') {
      if (roomDataProvider.player1.playerType == winner) {
        //player1 winner
        // gameDialogBox(context, '${roomDataProvider.player1.nickname} won!');
        gameDialog2(context, '${roomDataProvider.player1.nickname} won!');
        ...
        gameDialog2(context, '${roomDataProvider.player2.nickname} won!');
